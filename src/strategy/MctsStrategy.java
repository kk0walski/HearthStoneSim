...
public class MctsStrategy extends Strategy {
    ...
    public MctsStrategy(Game game, String name, List<Card> initialDeck, int initialHandSize) {
        super(game, name, initialDeck, initialHandSize);
    }

    public MctsStrategy(Game game, String name, List<Card> initialDeck, int initialHandSize, int timeForMctsMove, int totalTimeForMctsMoves) {
        super(game, name, initialDeck, initialHandSize);
